...
public class BeneficiaryBulkRequest   {
        ...
        @JsonProperty("ProjectBeneficiaries")
          @Valid
        @Size(min=1)         private List<ProjectBeneficiary> projectBeneficiaries = null;


        public BeneficiaryBulkRequest addProjectBeneficiariesItem(ProjectBeneficiary projectBeneficiariesItem) {
            if (this.projectBeneficiaries == null) {
            this.projectBeneficiaries = new ArrayList<>();
            }
        this.projectBeneficiaries.add(projectBeneficiariesItem);
        return this;
        }
