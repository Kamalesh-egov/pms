...
public class ProjectFacilityBulkRequest   {
        ...
        @JsonProperty("ProjectFacilities")
          @Valid
        @Size(min=1)         private List<ProjectFacility> projectFacilities = null;
        ...
        public ProjectFacilityBulkRequest addProjectFacilitiesItem(ProjectFacility projectFacilitiesItem) {
